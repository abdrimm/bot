...
if __name__ == "__main__":
    ...
    with open("creds/predictor.txt", "r") as f:
    ...
    request = "Пожалуйста, произнесите любые цифры с небольшими паузами "
    ...
    def get_text_messages(message):
        ...
        try:
            ...
            bot.send_message(user_id, "Извините, попробуйте еще раз")    
